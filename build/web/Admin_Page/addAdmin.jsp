<%-- 
    Document   : addAdmin
    Created on : Apr 29, 2022, 12:25:22 AM
    Author     : prana
--%>
                ...
                $('#reg-form').on('submit', function (event) {
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            if (data.trim() === 'done')
                            {
                                swal("Registered successfully..We are going to redirect to admin login page")
                                        .then((value) => {
                                            window.location = "Admin_Page/loginAdmin"
                                        });
                            } else
                            {
                                swal(data);
